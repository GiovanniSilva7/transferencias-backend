...
private final int de; private final int ate; private final BigDecimal percentual;
public RegraSomentePercentual(int de, int ate, BigDecimal percentual){ this.de=de; this.ate=ate; this.percentual=percentual; }
